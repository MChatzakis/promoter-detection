...
- Part 2: In part 2, promoter detection is implemented using [BERTFromMaskedLM](https://huggingface.co/docs/transformers/model_doc/bert), utilizing the positional encoding and self-attention from part 1. Promoter detection is a classification of DNA sequences to the classes "contain" or "not contain" a promoter.
...
## About
Part of the code and data were provided by [BRBIC LAB of EPFL](https://brbiclab.epfl.ch/), as part of the 3rd assignment of the [Deep Learning in Biomedicine](https://edu.epfl.ch/coursebook/en/deep-learning-in-biomedicine-CS-502) course. 
